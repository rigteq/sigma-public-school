...
<head>
	...
	<title>SIGMA PUBLIC SCHOOL | Raj Bagh Sahibabad</title>
	<!-- favicons Icons -->
	<link rel="apple-touch-icon" sizes="180x180" href="assets/images/logo-new.png" />
	<link rel="icon" type="image/png" sizes="32x32" href="assets/images/logo-new.png" />
	<link rel="icon" type="image/png" sizes="16x16" href="assets/images/logo-new.png" />
	<link rel="manifest" href="assets/images/favicons/site.webmanifest" />
	<meta name="description"
		content="SIGMA PUBLIC SCHOOL is a premium co-educational school in Sahibabad, Ghaziabad offering modern facilities, holistic learning, and strong academic support for young learners." />
	...
	<style>
		/* ── Hero Section: text contrast & gradient overlay ── */
		.main-slider-one__bg::after {
			content: "";
			position: absolute;
			inset: 0;
			background: linear-gradient(to right, rgba(0, 0, 0, 0.55) 0%, rgba(0, 0, 0, 0.25) 60%, rgba(0, 0, 0, 0.05) 100%);
			z-index: 1;
		}
		...
		.main-slider-one__title .main-slider-one__title__anim {
			color: #fff !important;
		...
		.footer-widget__gallery li a img {
			width: 100%;
			height: 100%;
			object-fit: cover;
			display: block;
		...
		.footer-widget__gallery li a:hover img {
...
<body>
	...
	<div class="page-wrapper">
			...
			<div class="container-fluid">
				<div class="main-header__inner">
					...
					<div class="main-header__right">
						...
						<a class="main-header__call" href="tel:8448644606">
							<i class=" icon-call main-header__call__icon"></i>
							<span class=" main-header__call__content">
								<span class="main-header__call__text">Call for
									Admissions</span><!-- /.main-header__call__text -->
								<span class="main-header__call__number">8448644606</span>
		...
		<section class="main-slider-one" id="home">
			...
			<div class="main-slider-one__carousel kidearn-owl__carousel owl-carousel" data-owl-options='{
		"loop": true,
		"animateOut": "fadeOut",
		"animateIn": "fadeIn",
		"items": 1,
							...
							<div class="row">
								<div class="col-md-12">
									<div class="main-slider-one__content">
										<h5 class="main-slider-one__sub-title">SIGMA PUBLIC SCHOOL</h5>
										<!-- slider-sub-title -->
				...
				<div class="row">
					<div class="col-xl-6 wow fadeInLeft" data-wow-delay="300ms">
						<div class="about-three__image">
							<div class="about-three__image__one kidearn-tilt"
								data-tilt-options='{ "glare": false, "maxGlare": 0, "maxTilt": 3, "speed": 700, "scale": 1 }'>
								<img src="assets/images/resources/about-3-1.jpg" alt="kidearn" />
								<div class="about-three__image__one-left"></div>
								<div class="about-three__image__one-right"></div>
								<div class="about-three__image__one-bottom"></div>
							</div>
							<div class="about-three__image__two wow fadeInUp" data-wow-delay="500ms">
								<img src="assets/images/resources/about-3-2.jpg" alt="kidearn" />
							</div>
							<div class="about-three__image__bg-shape">
								<img src="assets/images/shapes/about-3-shape-1.png" alt="kidearn" />
							</div>
						</div>
					</div>
					<div class="col-xl-6 wow fadeInRight" data-wow-delay="200ms">
						<div class="about-three__content">
							<div class="sec-title text-left">
								...
								<h3 class="sec-title__title">Sigma Public School: Modern Indian Education<br>Rooted in
									values &amp; excellence</h3><!-- /.sec-title__title -->
							</div><!-- /.sec-title -->
							<p class="about-three__content__text">
								Sigma Public School is a premier Indian school dedicated to academic excellence,
								character building and holistic development. We combine smart classrooms, activity-based
								learning and a disciplined study environment so every student grows into a confident,
								responsible citizen.
							</p>
							<ul class="about-three__content__lists">
								<li><span class="fa fa-check-circle"></span>Experienced faculty delivering modern Indian
									pedagogy</li>
								<li><span class="fa fa-check-circle"></span>Smart board and computer-based learning
									across all grades</li>
								<li><span class="fa fa-check-circle"></span>All-round personality development through
									sports, arts and values</li>
							</ul>
							<div class="about-three__info-wrapper">
								<div class="about-three__author">
									<div class="about-three__author__image"><img
											src="assets/images/resources/about-author-1.jpg" alt="kidearn" /></div>
									<img src="assets/images/resources/about-sign.png" alt="kidearn" />
									<p class="about-three__author__name">MR.rajesh Kumar, CEO</p>
								</div>
								<a class="about-three__call" href="tel:8448644606">
									<span class="about-three__call__icon">
										<i class=" icon-call"></i>
										<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 44 46">
											<path
												d="M24.7699 1.61608L24.7944 1.6288L24.8202 1.63873C31.0563 4.04205 35.7171 6.48718 38.824 9.77685C41.908 13.0424 43.5 17.1837 43.5 23.0795C43.5 28.8883 40.4975 33.6493 36.2695 37.2467C32.0378 40.8473 26.6146 43.2474 21.8898 44.3165C16.1833 45.6064 10.8543 43.2743 6.92284 39.1017C2.98715 34.9246 0.5 28.9455 0.5 23.0795C0.5 17.2539 3.97485 10.5057 8.81053 5.89765C13.6592 1.27714 19.6775 -1.02371 24.7699 1.61608Z"
												stroke="currentColor" />
										</svg>
									</span>
									<span class="about-three__call__content">
										<span class="about-three__call__number">8448644606</span>
		...
		<style>
			...
			.leader-card--principal .leader-card__avatar {
				background: linear-gradient(135deg, #2390FF, #1a6fd4);
			}

			.leader-card--director .leader-card__avatar {
				background: linear-gradient(135deg, #FFAA23, #e88e00);
			}
			...
			.leader-card--principal .leader-card__deco {
				background: #2390FF;
			}

			.leader-card--director .leader-card__deco {
				background: #FFAA23;
			}
		</style>
		...
		<section class="leadership-two">
			<div class="container">
				<div class="sec-title text-left">
					...
					<p class="mission-sigma-text">The curriculum at Sigma is conceived in such a way that everything the
						child learns at the preschool prepares him for an easy transition into Grade 1. This smooth step
						towards a bigger future is accomplished via a series of activities that are woven into academic
						programmes.</p>
				</div>
				<div class="row align-items-center mt-4">
					<div class="col-lg-6">
						<p>At Sigma Public School, we focus on creating a warm, joyful early years experience through
							activity-based learning, social-emotional development, and strong routines that make every
							child feel confident.</p>
					</div>
					<div class="col-lg-6">
						<div class="row">
							<div class="col-sm-6">
								<div class="leader-card leader-card--principal">
									...
									<span class="leader-card__badge"><i class="fa fa-graduation-cap"></i>
										Principal</span>
									<div class="leader-card__avatar">SG</div>
									<p class="leader-card__name">Mrs. Shalini Gupta</p>
									<p class="leader-card__desc">Oversees academic programs and ensures every child
										receives a caring, nurturing foundation.</p>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="leader-card leader-card--director">
									...
									<p class="leader-card__desc">Leads the school vision and champions a safe, nurturing
										environment for young learners.</p>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-xl-3 col-md-6">
						<div class="program-three__item wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='00ms'
							...
							<div class="program-three__item__content">
								...
								<h3 class="program-three__item__title"><a href="#">Toddler</a></h3>
								<!-- /.program-three__item__title -->
								<div class="program-three__item__age">(1.5-3 years)</div>
								<!-- /.program-three__item__age -->
								<p class="program-three__item__text">Nurturing early independence through play-based
									learning, social skills, and language exploration.</p>
								<!-- /.program-three__item__text -->
								<a class="program-three__item__rm" href="#"><span
					...
					<div class="col-xl-3 col-md-6">
						<div class="program-three__item wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='100ms'
							...
							<div class="program-three__item__content">
								...
								<h3 class="program-three__item__title"><a href="#">Preschool</a></h3>
								<!-- /.program-three__item__title -->
								<div class="program-three__item__age">(2-3 years)</div>
								<!-- /.program-three__item__age -->
								<p class="program-three__item__text">A gentle preschool curriculum focused on creative
									discovery, sensory play, and developing strong routines.</p>
								<!-- /.program-three__item__text -->
								<a class="program-three__item__rm" href="#"><span
										class="icon-right-arrow"></span></a><!-- /.program-three__item__text -->
							</div><!-- /.program-three__item__content -->
					...
					<div class="col-xl-3 col-md-6">
						<div class="program-three__item wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='200ms'
							...
							<div class="program-three__item__content">
								...
								<h3 class="program-three__item__title"><a href="#">Kindergarten</a></h3>
								<!-- /.program-three__item__title -->
								<div class="program-three__item__age">(4-5 years)</div>
								<!-- /.program-three__item__age -->
								<p class="program-three__item__text">Foundational learning with phonics, numeracy, art,
									and physical activity to prepare children for Grade 1.</p>
								<!-- /.program-three__item__text -->
								<a class="program-three__item__rm" href="#"><span
										class="icon-right-arrow"></span></a><!-- /.program-three__item__text -->
							</div><!-- /.program-three__item__content -->
					...
					<div class="col-xl-3 col-md-6">
						<div class="program-three__item wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='300ms'
							...
							<div class="program-three__item__content">
								...
								<h3 class="program-three__item__title"><a href="#">Flex-care</a></h3>
								<!-- /.program-three__item__title -->
								<div class="program-three__item__age">(5-12 years)</div>
								<!-- /.program-three__item__age -->
								<p class="program-three__item__text">After-school support with homework help, enrichment
									activities, and supervised fun for busy families.</p>
								<!-- /.program-three__item__text -->
								<a class="program-three__item__rm" href="#"><span
										class="icon-right-arrow"></span></a><!-- /.program-three__item__text -->
							</div><!-- /.program-three__item__content -->
					...
					<div class="row">
						...
						<div class="col-lg-6">
							...
							<div class="cta-one__thumb">
								<div class="cta-one__thumb__two"><img src="assets/images/shapes/cta-2.png"
										alt="kidearn" /></div>
							</div><!-- /.cta-one__thumb -->
						</div>
					</div>
		...
		<section class="team-three">
			<div class="container">
				<div class="sec-title text-center">
					...
					<h6 class="sec-title__tagline">Our Teacher</h6><!-- /.sec-title__tagline -->

					<h3 class="sec-title__title">Meet our expert & smart<br> superheroes!</h3>
					<!-- /.sec-title__title -->
				</div><!-- /.sec-title -->
				<div class="team-three__carousel kidearn-owl__carousel kidearn-owl__carousel--basic-nav kidearn-owl__carousel--with-shadow owl-carousel owl-theme"
					data-owl-options='{
			"items": 1,
			"margin": 0,
			"loop": false,
				...
				"992": {
					...
					<div class="item">
						<div class="team-card-three wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='00ms'
							...
							<div class="team-card-three__image">
								<img src="assets/images/team/team-3-1.jpg" alt="Anjali Sharma">
							</div><!-- /.team-card-three__image -->
							<div class="team-card-three__normal">
								<h3 class="team-card-three__normal__title">Anjali Sharma</h3>
								<!-- /.team-card-three__title -->
								<p class="team-card-three__normal__designation">English Teacher</p>
								<!-- /.team-card-three__designation -->
								<div class="team-card-three__normal__social">
								...
								</div><!-- /.list-unstyled team-card-three__social__list -->
							</div><!-- /.team-card-three__normal -->
							<div class="team-card-three__hover">
								<h3 class="team-card-three__title">
									<a href="#">Anjali Sharma</a>
								</h3><!-- /.team-card-three__title -->
								<p class="team-card-three__designation">English Teacher</p>
								<!-- /.team-card-three__designation -->
								...
								<a class="team-card-three__rm" href="#"><span class="icon-right-arrow"></span></a>
							</div><!-- /.team-card-three__hover -->
						</div><!-- /.team-card-three -->
					</div><!-- /.team-item -->
					<div class="item">
						<div class="team-card-three wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='100ms'
							style='--accent-color: #F25334;'>
							<div class="team-card-three__image">
								<img src="assets/images/team/team-3-2.jpg" alt="Neha Verma">
							</div><!-- /.team-card-three__image -->
							<div class="team-card-three__normal">
								<h3 class="team-card-three__normal__title">Neha Verma</h3>
								<!-- /.team-card-three__title -->
								<p class="team-card-three__normal__designation">Mathematics Teacher</p>
								<!-- /.team-card-three__designation -->
								<div class="team-card-three__normal__social">
									<a class="fb" href="https://facebook.com/">
										<span class="social-bg">
							...
							<div class="team-card-three__hover">
								...
								<p class="team-card-three__designation">Mathematics Teacher</p>
								<!-- /.team-card-three__designation -->
								<div class="team-card-three__social">
									<a class="fb" href="https://facebook.com/">
										<span class="social-bg">
					...
					<div class="item">
						<div class="team-card-three wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='200ms'
							style='--accent-color: #75C137;'>
							<div class="team-card-three__image">
								<img src="assets/images/team/team-3-3.jpg" alt="Aman Sharma">
							</div><!-- /.team-card-three__image -->
							<div class="team-card-three__normal">
								<h3 class="team-card-three__normal__title">Aman Sharma</h3>
								<!-- /.team-card-three__title -->
								<p class="team-card-three__normal__designation">Science Teacher</p>
								<!-- /.team-card-three__designation -->
								<div class="team-card-three__normal__social">
									<a class="fb" href="https://facebook.com/">
										<span class="social-bg">
							...
							<div class="team-card-three__hover">
								<h3 class="team-card-three__title">
									<a href="#">Aman Sharma</a>
								</h3><!-- /.team-card-three__title -->
								<p class="team-card-three__designation">Science Teacher</p>
								<!-- /.team-card-three__designation -->
								<div class="team-card-three__social">
									<a class="fb" href="https://facebook.com/">
										<span class="social-bg">
		...
		<section class="funfact-two">
			...
			<div class="funfact-two__shape2 kidearn-splax" data-para-options='{"orientation": "left", "scale": 1.5, "delay": ".3", "transition": "cubic-bezier(0,0,0,1)", "overflow": true
		}'><img src="assets/images/shapes/funfact-shape-6.png" alt="kidearn" />
			</div>
			<div class="funfact-two__shape3 kidearn-splax" data-para-options='{"orientation": "right", "scale": 1.5, "delay": ".4", "transition": "cubic-bezier(0,0,0,1)", "overflow": true
									...
									<div class="funfact-two__item" style="--accent-color: #75C137;">
										...
										<div class="funfact-two__count">
											<span class="count-box">
												<span class="count-text" data-stop="200" data-speed="1500"></span>
											</span>
					...
					<div class="col-xl-6">
						<div class="kidearn-stretch-element-inside-column">
							<div class="funfact-two__image wow slideInRight" data-wow-delay="300ms">
								<img src="assets/images/resources/funfact-1.jpg" alt="kidearn">
		...
		<section class="testimonial-three">
			<div class="container">
				<div class="testimonial-three__area">
					<div class="testimonial-three__bg"></div>
					<div class="testimonial-three__shape1 kidearn-splax"
						style="background-image: url(assets/images/shapes/testimonial-shape-5.png);" data-para-options='{
				"orientation": "right",
				"scale": 1.2,
				"delay": ".3",
				...
				"overflow": true
					...
					<div class="testimonial-three__shape2">
						<img src="assets/images/shapes/testimonial-shape-6.png" alt="kidearn" />
					</div>
					<div class="sec-title text-center">
					...
					<div class="testimonial-three__carousel kidearn-owl__carousel owl-carousel owl-theme"
						data-owl-options='{
					"items": 1,
					"margin": 0,
					"loop": true,
					...
					"autoplay": false
						...
						<div class="item">
							<div class="testimonial-three__item">
								<div class="testimonial-three__item__quote">
									Sigma Public School has helped our son grow in confidence and academics. The
									teachers are attentive, the classrooms are well-equipped, and the school's
								...
								<div class="testimonial-three__item__wrapper">
									<div class="testimonial-three__item__author">
										<span class="testimonial-three__item__author__icon fa fa-user-circle"
						...
						<div class="item">
							<div class="testimonial-three__item">
								<div class="testimonial-three__item__quote">
									Our daughter feels supported and motivated every day. The sports, arts, and
									value-based lessons give her a balanced school life, and the staff are always
									welcoming.
								</div>
								<div class="testimonial-three__item__wrapper">
									<div class="testimonial-three__item__author">
						...
						<div class="item">
							<div class="testimonial-three__item">
								<div class="testimonial-three__item__quote">
									A warm school with strong discipline and caring teachers. The learning journey has
									been joyful for my child.
								</div>
								<div class="testimonial-three__item__wrapper">
									<div class="testimonial-three__item__author">
										<span class="testimonial-three__item__author__icon fa fa-user-circle"
						...
						<div class="item">
							<div class="testimonial-three__item">
								<div class="testimonial-three__item__quote">
									Excellent environment, friendly staff, and good communication. Admission process was
									smooth and the school feels safe.
								</div>
								<div class="testimonial-three__item__wrapper">
									<div class="testimonial-three__item__author">
										<span class="testimonial-three__item__author__icon fa fa-user-circle"
					...
					<div class="testimonial-three__carousel-nav"></div><!-- /.custome-nav -->
				</div>
			</div>
		</section>
		<section class="event-one" id="events">
			<div class="container">
				<div class="sec-title text-center">
					...
					<h6 class="sec-title__tagline">Latest Events</h6><!-- /.sec-title__tagline -->

					<h3 class="sec-title__title">Upcoming school activities &<br> events schedule</h3>
					<!-- /.sec-title__title -->
				</div><!-- /.sec-title -->
				<div class="row">
					<div class="col-md-12 col-lg-8 wow fadeInUp" data-wow-delay="100ms">
						<div class="event-card @@extraClassName" style='--accent-color: #F25334;'>
							<div class="row">
								<div class="col-md-5">
									<div class="event-card__image">
										<img src="assets/images/resources/event-1-1.jpg"
											alt="The complete web developer guideline 2023">
										<div class="event-card__date"><span class="event-card__date-left">16</span>March
											2023</div><!-- /.event-card__date -->
									</div><!-- /.event-card__image -->
								</div>
								<div class="col-md-7 d-flex align-items-center">
									<div class="event-card__content">
										<div class="event-card__cats"><a href="#">Kindergarten</a></div>
										<!-- /.event-card__cats -->
										<ul class="event-card__lists">
											<li><span class="icon-clock1"></span>08:00am - 05:00pm</li>
											<li><span class="icon-location-fill"></span>95/2, Raj Bagh, Sahibabad,
												Ghaziabad, Uttar Pradesh 201005</li>
										</ul><!-- /.event-card__lists -->
										<h3 class="event-card__title"><a href="#">The complete web developer guideline
												2023</a></h3><!-- /.event-card__title -->
									</div><!-- /.event-card__content -->
								</div>
							</div>
						</div><!-- /.event-card -->
						<div class="event-card @@extraClassName" style='--accent-color: #2390FF;'>
							<div class="row">
								<div class="col-md-5">
									<div class="event-card__image">
										<img src="assets/images/resources/event-1-2.jpg"
								...
								<div class="col-md-7 d-flex align-items-center">
									<div class="event-card__content">
										...
										<h3 class="event-card__title"><a href="#">Let’s spend summer together with your
												teachers</a></h3><!-- /.event-card__title -->
									</div><!-- /.event-card__content -->
								</div>
							</div>
						</div><!-- /.event-card -->
					</div><!-- /.col-md-12 col-lg-8 -->
					<div class="col-md-12 col-lg-4 wow fadeInRight" data-wow-delay="200ms">
						<div class="event-one__mail-area"
							style="background-image: url(assets/images/resources/mail-bg.jpg);">
							<div class="event-one__mail-icon"><span class="icon-envelope-open"></span></div>
							<h3 class="event-one__mail-title">Subscribe to our newsletter for daily updates</h3>
							<form action="#" data-url="MAILCHIMP_FORM_URL" class="event-one__mail-form mc-form">
								<input type="text" name="EMAIL" placeholder="Email Address">
								<button type="submit" class="kidearn-btn">
									<span>Subscribe</span>
								</button>
								<p class="event-one__mail-form__text">Get Latest Events and Keep Update</p>
							</form><!-- /. mc-form -->
		...
		<section class="blog-one blog-one--home-three">
			...
			<div class="blog-one--home-three__bg" style="background-image: url(assets/images/shapes/blog-bg-3.png);">
			</div>
			<div class="container">
				<div class="sec-title text-center">
					...
					<h3 class="sec-title__title">Checkout our latest news<br> updates & articles</h3>
					<!-- /.sec-title__title -->
				</div><!-- /.sec-title -->
				<div class="blog-one__carousel kidearn-owl__carousel kidearn-owl__carousel--with-shadow kidearn-owl__carousel--basic-nav owl-carousel owl-theme"
					data-owl-options='{
				"items": 1,
				"margin": 0,
				"loop": false,
				...
				"responsive": {
					...
					<div class="item">
						<div class="blog-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='000ms'>
							<div class="blog-card__image">
								...
								<div class="blog-card__image__layer"
									style="background-image: url(assets/images/blog/blog-1-1.png);"></div>
								<div class="blog-card__image__layer"
									style="background-image: url(assets/images/blog/blog-1-1.png);"></div>
								<div class="blog-card__image__layer"
									style="background-image: url(assets/images/blog/blog-1-1.png);"></div>
								<div class="blog-card__image__layer"
									style="background-image: url(assets/images/blog/blog-1-1.png);"></div>
								<a href="#" class="blog-card__image__link"><span class="sr-only">10 Easy steps to more
										learn about play</span>
									<!-- /.sr-only --></a>
							</div><!-- /.blog-card__image -->
							<div class="blog-card__content">
								<div class="blog-card__content__top">
									<a href="#" class="blog-card__category">Kindergarten</a>
									<div class="blog-card__date">30 Mar, 2023</div><!-- /.blog-card__date -->
								</div><!-- /.blog-card__content__top -->
								<h3 class="blog-card__title"><a href="#">10 Easy steps to more learn about play</a></h3>
								<!-- /.blog-card__title -->
								<div class="blog-card__content__bottom">
									<div class="blog-card__author">
										<div class="blog-card__author__image">
											<img src="assets/images/blog/blog-author-1-1.jpg" alt="Wade Warren">
										</div><!-- /.blog-card__author__image -->
										<div class="blog-card__author__content">
											<h4 class="blog-card__author__name">Wade Warren</h4>
											<!-- /.blog-card__author__name -->
											<p class="blog-card__author__designation">CEO</p>
											<!-- /.blog-card__author__designation -->
										</div><!-- /.blog-card__author__content -->
									</div><!-- /.blog-card__author -->
									<a href="#" class="blog-card__link">
										<span class="sr-only">Read more</span><!-- /.sr-only -->
					...
					<div class="item">
						<div class="blog-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='100ms'
							...
							<div class="blog-card__image">
								...
								<div class="blog-card__image__layer"
									style="background-image: url(assets/images/blog/blog-1-2.png);"></div>
								<div class="blog-card__image__layer"
									style="background-image: url(assets/images/blog/blog-1-2.png);"></div>
								<div class="blog-card__image__layer"
									style="background-image: url(assets/images/blog/blog-1-2.png);"></div>
								<div class="blog-card__image__layer"
									style="background-image: url(assets/images/blog/blog-1-2.png);"></div>
								<a href="#" class="blog-card__image__link"><span class="sr-only">That jerk from finance
										really threw me</span>
									<!-- /.sr-only --></a>
							</div><!-- /.blog-card__image -->
							<div class="blog-card__content">
								<div class="blog-card__content__top">
									<a href="#" class="blog-card__category">Painting</a>
									<div class="blog-card__date">30 Mar, 2023</div><!-- /.blog-card__date -->
								</div><!-- /.blog-card__content__top -->
								<h3 class="blog-card__title"><a href="#">That jerk from finance really threw me</a></h3>
								<!-- /.blog-card__title -->
								<div class="blog-card__content__bottom">
									<div class="blog-card__author">
										<div class="blog-card__author__image">
					...
					<div class="item">
						<div class="blog-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='200ms'
							style='--accent-color: #2390FF;'>
							<div class="blog-card__image">
								<img src="assets/images/blog/blog-1-3.png" alt="Form without content style without">
								<div class="blog-card__image__layer"
									style="background-image: url(assets/images/blog/blog-1-3.png);"></div>
								<div class="blog-card__image__layer"
									style="background-image: url(assets/images/blog/blog-1-3.png);"></div>
								<div class="blog-card__image__layer"
									style="background-image: url(assets/images/blog/blog-1-3.png);"></div>
								<div class="blog-card__image__layer"
									style="background-image: url(assets/images/blog/blog-1-3.png);"></div>
								<a href="#" class="blog-card__image__link"><span class="sr-only">Form without content
										style without</span>
									<!-- /.sr-only --></a>
							</div><!-- /.blog-card__image -->
							<div class="blog-card__content">
								<div class="blog-card__content__top">
									<a href="#" class="blog-card__category">Gaming</a>
									<div class="blog-card__date">30 Mar, 2023</div><!-- /.blog-card__date -->
								</div><!-- /.blog-card__content__top -->
								<h3 class="blog-card__title"><a href="#">Form without content style without</a></h3>
								<!-- /.blog-card__title -->
								<div class="blog-card__content__bottom">
									<div class="blog-card__author">
										<div class="blog-card__author__image">
		...
		<section class="contact-three" id="contact" style="padding-bottom: 80px;">
			<div class="container">
				<div class="row">
					<div class="col-lg-6 wow fadeInUp" data-wow-delay="200ms">
						<div class="contact-three__thumb">
							...
							<div class="contact-three__thumb__shape2">
								<img src="assets/images/shapes/contact-2-shape-2.png" alt="kidearn" />
							</div>
							<div class="contact-three__thumb__shape3">
								<img src="assets/images/shapes/contact-2-shape-3.png" alt="kidearn" />
							</div>
						</div>
					</div>
					<div class="col-lg-6 wow fadeInRight" data-wow-delay="200ms">
						...
						<form class="contact-one__form contact-form-validated form-one" action="#">
							<div class="form-one__group">
								...
								<div class="form-one__control form-one__control--full">
									<button type="submit" class="kidearn-btn kidearn-btn--xl"><span>Get In
											Touch</span></button>
								</div><!-- /.form-one__control -->
							</div><!-- /.form-one__group -->
						</form>
		...
		<style>
			/* ── Gallery Slider uniform image height ── */
			.gallery-one--home-three .gallery-one__card {
				height: 260px;
			}

			.gallery-one--home-three .gallery-one__card img {
				width: 100%;
				height: 100%;
				object-fit: cover;
				display: block;
			...
			.gallery-one--home-three .sec-title {
				padding: 60px 0 40px;
			}
		...
		<section class="gallery-one gallery-one--home-three" id="gallery">
			<div class="container">
				<div class="sec-title text-center">
					<h6 class="sec-title__tagline">Our Campus</h6>
					<h3 class="sec-title__title">A Glimpse into School Life<br>at Sigma Public School</h3>
				</div>
				...
				"1300": {
					...
					<div class="item">
						<div class="gallery-one__card">
							<img src="assets/images/gallery/gallery-1.png" alt="Sigma Public School Campus 1">
					...
					<div class="item">
						<div class="gallery-one__card">
							<img src="assets/images/gallery/gallery-2.png" alt="Sigma Public School Campus 2">
							<div class="gallery-one__card__hover">
					...
					<div class="item">
						<div class="gallery-one__card">
							<img src="assets/images/gallery/gallery-3.png" alt="Sigma Public School Campus 3">
							<div class="gallery-one__card__hover">
					...
					<div class="item">
						<div class="gallery-one__card">
							<img src="assets/images/gallery/gallery-4.png" alt="Sigma Public School Campus 4">
							<div class="gallery-one__card__hover">
					...
					<div class="item">
						<div class="gallery-one__card">
							<img src="assets/images/gallery/gallery-5.png" alt="Sigma Public School Campus 5">
							<div class="gallery-one__card__hover">
					...
					<div class="item">
						<div class="gallery-one__card">
							<img src="assets/images/gallery/gallery-6.png" alt="Sigma Public School Campus 6">
							<div class="gallery-one__card__hover">
					...
					<div class="item">
						<div class="gallery-one__card">
							<img src="assets/images/gallery/gallery-7.png" alt="Sigma Public School Campus 7">
							<div class="gallery-one__card__hover">
								<a href="assets/images/gallery/gallery-7.png" class="img-popup">
									<span class="gallery-one__card__icon"></span>
								</a>
							</div><!-- /.gallery-one__card__hover -->
						</div><!-- /.gallery-one__card -->
		...
		<footer class="main-footer-two" style="background-image: url(assets/images/shapes/footer-bg-2.png);">
							...
							<div class="footer-widget footer-widget--about">
								...
								<ul class="list-unstyled footer-widget__info">
									<li>
										...
										<a href="#">95/2, Raj Bagh, Sahibabad, Ghaziabad, Uttar Pradesh 201005</a>
									</li>
									<li>
										<i class="icon-call footer-widget__info__icon"></i>
										<a href="tel:8448644606">8448644606</a>
									</li>
									<li>
										<i class="icon-email1 footer-widget__info__icon"></i>
										<a href="mailto:info@sigmapublicschool\.in">info@sigmapublicschool\.in</a>
									</li>
								</ul><!-- /.list-unstyled -->
								<div class="footer-widget__social">
									...
									<a
										href="https://www.facebook.com/people/sigma-public-school-Rajbagh-sahibabad/61585979680698/#">
						...
						<div class="col-md-6 col-xl-4">
							<div class="footer-widget footer-widget--gallery">
								...
								<ul class="list-unstyled footer-widget__gallery">
									<li>
										<a class="img-popup" href="assets/images/gallery/gallery-1.png">
											<img src="assets/images/gallery/gallery-1.png" alt="Sigma School Gallery 1"
												loading="lazy">
										</a>
									</li>
									<li>
										<a class="img-popup" href="assets/images/gallery/gallery-2.png">
											<img src="assets/images/gallery/gallery-2.png" alt="Sigma School Gallery 2"
												loading="lazy">
										</a>
									</li>
									<li>
										<a class="img-popup" href="assets/images/gallery/gallery-3.png">
											<img src="assets/images/gallery/gallery-3.png" alt="Sigma School Gallery 3"
												loading="lazy">
										</a>
									</li>
									<li>
										<a class="img-popup" href="assets/images/gallery/gallery-4.png">
											<img src="assets/images/gallery/gallery-4.png" alt="Sigma School Gallery 4"
												loading="lazy">
										</a>
									</li>
									<li>
										<a class="img-popup" href="assets/images/gallery/gallery-5.png">
											<img src="assets/images/gallery/gallery-5.png" alt="Sigma School Gallery 5"
												loading="lazy">
										</a>
									</li>
									<li>
										<a class="img-popup" href="assets/images/gallery/gallery-6.png">
											<img src="assets/images/gallery/gallery-6.png" alt="Sigma School Gallery 6"
												loading="lazy">
										</a>
									</li>
			...
			</div><!-- /.main-footer-two__top -->
			<div class="main-footer-two__bottom">
				<div class="container">
					<div class="main-footer-two__bottom__inner">
						<p class="main-footer-two__copyright">
							&copy; Copyright <span class="dynamic-year"></span> by SIGMA PUBLIC SCHOOL.
						</p>
					</div><!-- /.main-footer-two__inner -->
				</div><!-- /.container -->
			</div><!-- /.main-footer-two__bottom -->
	...
	<a href="https://wa.me/918448644606?text=Hello%20Sigma%20Public%20School%20Admissions" class="whatsapp-float"
	...
	<div class="quick-callback-notice" id="quickCallbackNotice">
		...
		<div class="quick-callback-notice__text">We can call you back in minutes to help with admissions or questions.
		</div>
